...
var incompleteTaskHolder = document.getElementById('active-section__list'); //ul of #incompleteTasks
var completedTasksHolder = document.getElementById('complete-section__ul'); //completed-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  editButton.className += ' item__btn';

  deleteButton.className = 'btn-delete';
  deleteButton.className += ' item__btn';
